...
export function ThemeToggle({ className = "", asButton = true }: { className?: string; asButton?: boolean }) {
  ...
  if (!asButton) {
    return <span className={"flex items-center justify-center " + className}>{icon}</span>;
  }
