    ...
    <main className="min-h-screen pb-32">
      ...
      <div className="px-6 py-5 max-w-lg mx-auto">
        <button
          ...
          className="w-full aspect-square rounded-2xl bg-gradient-to-br from-teal to-green relative overflow-hidden mb-5 block"
          style={
            coverImageBase64
        ...
        >
          <span className="absolute bottom-3 right-3 bg-black/55 text-white text-xs font-bold px-3 py-1.5 rounded-lg">
        ...
        <input
          ...
          className="w-full bg-surface border border-lineStrong rounded-xl px-4 py-3 text-sm font-semibold mb-4 outline-none"
        />
        ...
        <textarea
          ...
          rows={2}
          className="w-full bg-surface border border-lineStrong rounded-xl px-4 py-3 text-sm mb-2 outline-none resize-none"
        />
