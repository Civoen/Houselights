...
// Next.js's App Router error boundary — catches anything that throws
// during render or in an effect, anywhere below the root layout. Without
// this, an unexpected error shows Next's own generic crash screen instead
// of anything in this app's control. This is deliberately a developer-
// facing screen (real message, digest, stack), not a softened end-user
// one — that's what was actually asked for here.
