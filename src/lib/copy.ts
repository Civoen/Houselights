...
export const copy = {
  ...
  home: {
    tagline: "Get ready for your next show.",
  ...
  create: {
    ...
    generatePreviewNote: "Preview updates as you change palette, background and artists.",
    ...
    textureLabel: "Pattern",
    appearanceLight: "Light",
    appearanceDark: "Dark",
    headlinerLabel: "Headliner",
    supportArtistsLabel: "Also show on cover",
    supportArtistsNote: "Named next to the headliner; the rest fold into a \"+ N more\" count.",
    coverDateUnset: "Date TBC",
  ...
  settings: {
    ...
    syncLabel: "Sync between devices",
    syncNote: "Manual, not automatic. Push from the device you just used, then pull on the other one.",
    syncPushButton: "Sync to cloud",
    syncPullButton: "Sync from cloud",
    syncPushing: "Syncing…",
    syncPulling: "Checking…",
    syncPushDonePrefix: "Synced",
    syncNoDataError: "No synced backup found yet. Push from another device first.",
    syncPullConfirmPrompt: "This replaces everything currently saved on this device with the synced backup from",
    syncConfirmButton: "Yes, apply",
