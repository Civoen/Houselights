...
// Both counts only ever grow (playlists/drafts accumulate, wristbands
// only ever unlock, never re-lock outside of Clear progress) — so a
// simple "current count vs last-seen count" comparison is enough, no
// need to track individual IDs.
